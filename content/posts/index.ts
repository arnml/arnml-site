...
export const posts: Record<Locale, Post[]> = {
  en: [softwareDifficulty.en, agents.en, shipping.en, optimization.en, microservices.en],
  es: [softwareDifficulty.es, agents.es, shipping.es, optimization.es, microservices.es],
  pt: [softwareDifficulty.pt, agents.pt, shipping.pt, optimization.pt, microservices.pt],
};
